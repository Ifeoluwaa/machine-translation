...
class BytePairTokenizer:
    ...
    def train(self, file_path: str, save_to: str, column_name: str) -> None:
        ...
        eng_corpus = data_file[column_name].tolist()

        # Tokenize only the English part
        self.tokenizer.train_from_iterator(eng_corpus, trainer=self.trainer)
...
class BBPETokenizer:
    def __init__(self, source_vocab_size: int, special_tokens=["<|endoftext|>"]):
...
def eng_load_tokenizer(path: str):
